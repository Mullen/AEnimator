...
Destroy input managers

*/

ParallaxSection.prototype.destroyScrollManager = function(){
	if(this.scrollManager){
		this.scrollManager.kill();
		this.scrollManager = null;
		delete this.scrollManager;
	}
};

ParallaxSection.prototype.destroyPassiveParallaxInputManager = function(){
	if(this.passiveParallaxInputManager){
		this.passiveParallaxInputManager.kill();
		this.passiveParallaxInputManager = null;
		delete this.passiveParallaxInputManager;
	}
};



ParallaxSection.prototype.show = function(){
	if(this.$parallaxElementsContainer){
		this.$parallaxElementsContainer.fadeIn(750);
	}
};

ParallaxSection.prototype.hide = function(){
	if(this.$parallaxElementsContainer){
		this.$parallaxElementsContainer.fadeOut();
	}
};